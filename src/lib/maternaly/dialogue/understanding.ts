...
Usa selection.sessionId únicamente de offeredSessions y con cita del mensaje que identifique la opción. Si «la otra» puede ser más de una, pregunta cuál. No inventes IDs. Ubicaciones se normalizan a bilbao/erandio/online; modalidad presencial/online; etapa embarazo/postparto/otros.
...
Si no comprendes algo, indícalo en ambiguities; nunca inventes datos. serviceId identifica el tema principal; las preguntas llevan su propio servicio. goal explore/scope catalog para descubrir opciones, no para una respuesta de datos. Máximo 10 actualizaciones, 4 preguntas y 3 ambigüedades.`;
