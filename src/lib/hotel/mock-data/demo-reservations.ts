...
export const DEMO_RESERVATION_RECORDS: ReservationRecord[] = [
  {
    ...
    petKey: buildPetKey("Luca", "Carolina Rodríguez López", "646376965"),
    status: "confirmada",
    ...
    createdAt: now,
    updatedAt: now,
    ownerName: "Carolina Rodríguez López",
    ownerEmail: "carolinarolopez381@gmail.com",
    petName: "Luca",
    phone: "646376965",
    checkInDate: "2026-08-17",
    checkInSlot: "afternoon",
...
export const DEMO_EMAIL_INBOX = [
  {
    ...
    summary:
      "Carolina Rodriguez Lopez solicita estancia para Luca del 2026-08-17 13:00 al 2026-08-28 13:00, telefono 646376965.",
  },
  {
    id: "email-002",
